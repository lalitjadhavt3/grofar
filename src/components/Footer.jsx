    ...
    <div className='container'>
     <div className='row'>
      ...
      <aside className='col-md'>
       ...
       <ul className='list-unstyled list-padding'>
        <li>
         <a href='promo_details.html' className='text-dark'>
          {' '}
          Promo Details{' '}
         </a>
        </li>
    ...
    <div className='container'>
     <div className='row'>
      <div className='col-md-6'>
       ...
       <span className='pr-2'>
        <a href='privacy.html' className='text-dark'>
         Privacy
        </a>
       </span>
       <span className='pr-2'>
        <a href='terms%26conditions.html' className='text-dark'>
         Terms & Conditions
        </a>
       </span>
      </div>
      <div className='col-md-6 text-md-right'>
       <a href>
        <img src='../assets/img/appstore.png' height='30' />
       </a>
       <a href>
        <img src='../assets/img/playmarket.png' height='30' />
       </a>
      </div>
     </div>
    </div>
